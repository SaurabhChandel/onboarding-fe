...
export default class AntDSider extends React.Component {
  handleClick = e => {
    console.log("click ", e);
  };
  ...
  getProfileDiv = (personDetails) => {
    ...
    <div className='profile'>
        ...
        <div className='content'>
            ...
            <p className='user-type'>{personDetails.userType}</p>
        </div>
    </div>
    )
}
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <Menu.Item key="3">Batches</Menu.Item>
        <Menu.ItemGroup key="g1" title="Manage">
          <Menu.Item key="4">A</Menu.Item>
          <Menu.Item key="5">B</Menu.Item>
        </Menu.ItemGroup>
